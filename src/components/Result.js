...
const Result = ({ showResult, quizs, marks, startOver }) => {
    return (
        <section className="adv-back text-white font-es" style={{ display: `${showResult ? 'block' : 'none'}` }}>
            <div className="container">
                <div className="row vh-100 align-items-center justify-content-center">
                    <div className="col-lg-6">
                        <div className={`text-light text-center p-5 rounded ${marks > (quizs.length * 5 / 2) ? 'rgb-back' : 'bg-danger'}`}>
